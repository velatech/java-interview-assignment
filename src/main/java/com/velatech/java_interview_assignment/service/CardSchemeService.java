...
import com.velatech.java_interview_assignment.exception.InvalidInputExceptionHandler;
...
public interface CardSchemeService {
    CardVerificationResponse performCardVerification(String cardNumber, HttpEntity<?> entity) throws HttpStatusCodeException, InvalidInputExceptionHandler;
